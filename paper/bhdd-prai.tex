...
\thanks{This dataset was collected and analyzed in 2019.}
}

\author{
  \IEEEauthorblockN{1\textsuperscript{st} Swan Htet Aung}
  \IEEEauthorblockA{\textit{Expa.AI} \\
  Yangon, Myanmar \\
  swan@expa.ai}
  \and
  \IEEEauthorblockN{2\textsuperscript{nd} Hein Htet}
  \IEEEauthorblockA{\textit{Expa.AI} \\
  Yangon, Myanmar}
  \and
  \IEEEauthorblockN{3\textsuperscript{rd} Htoo Say Wah Khaing}
  \IEEEauthorblockA{\textit{Expa.AI} \\
  Yangon, Myanmar}
  \and
  \IEEEauthorblockN{4\textsuperscript{th} Thuya Myo Nyunt}
  \IEEEauthorblockA{\textit{Expa.AI} \\
  Yangon, Myanmar}
}
...
BHDD is available under CC BY-SA 4.0 at
...
BHDD is at \url{https://github.com/baseresearch/BHDD} under CC BY-SA 4.0,
